        ...
        <section className="w-full rounded-3xl border border-[var(--border)] bg-[var(--surface)] p-7 shadow-sm">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <label className="block">
              ...
              <input required type="password" autoComplete="current-password" value={password} onChange={(event) => setPassword(event.target.value)} className="w-full rounded-xl border border-[var(--border)] bg-[var(--background)] px-4 py-3 outline-none focus:ring-2 focus:ring-[var(--border)]" placeholder="Your password" />
            </label>
          ...
          <p className="mt-6 text-center text-sm text-[var(--muted)]">
            ...
            <Link href="/signup" className="font-medium text-[var(--foreground)] underline">Create one</Link>
          </p>
        </section>
      </div>
    </main>
