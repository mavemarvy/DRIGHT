...
const STORAGE_KEY = "dright.correct-score-planner.v1";
const PAGE_SIZE = 40;
...
export default function BetCombinationsPage() {
  ...
  function exportCsv() {
    ...
    anchor.href = url;
    anchor.download = "dright-correct-score-combinations.csv";
    anchor.click();
      ...
      <header className="sticky top-0 z-20 border-b border-[var(--border)] bg-[var(--background)]/95 backdrop-blur">
        <div className="mx-auto flex min-h-16 max-w-7xl items-center gap-3 px-4 py-3 sm:px-6 lg:px-8">
          ...
          <div className="min-w-0">
            <h1 className="truncate font-semibold">Correct Score Combination Planner</h1>
            <p className="truncate text-xs text-[var(--muted)]">
              676 two-match combinations
            </p>
          </div>
        </div>
      </header>
      ...
      <div className="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
        <section className="rounded-3xl border border-[var(--border)] bg-[var(--surface)] p-5 sm:p-7">
          <div className="grid gap-5 lg:grid-cols-[1fr_auto] lg:items-end">
            <div>
              <p className="text-sm font-medium text-[var(--muted)]">Current pair</p>
        ...
        <section className="mt-5 rounded-3xl border border-[var(--border)] bg-[var(--surface)] p-4 sm:p-5">
          <div className="flex flex-col gap-3 xl:flex-row xl:items-center xl:justify-between">
            ...
            <div className="flex flex-wrap gap-2">
              <button
                ...
                className="inline-flex items-center gap-2 rounded-xl bg-[var(--primary)] px-4 py-2.5 text-sm font-medium text-[var(--primary-contrast)] disabled:cursor-not-allowed disabled:opacity-50"
              >
                <Clipboard size={17} />
                Copy next unplaced
              </button>
          ...
          <div className="mt-4 rounded-2xl border border-[var(--border)] bg-[var(--background)] px-4 py-3 text-xs leading-5 text-[var(--muted)]">
            This planner copies and tracks combinations only. It does not sign in to a bookmaker,
