...
const primary = [["Dashboard","/dashboard",Home,null],["Marketplace","/marketplace",Compass,null],["Notifications","/notifications",Bell,"announcements"]] as const;
...
export function AppShell({ children }: { children: React.ReactNode }) {
  ...
  const p = filterItems(primary), a = filterItems(account), g = filterItems(growth);
